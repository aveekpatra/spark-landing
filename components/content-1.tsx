        ...
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
                <div className="relative z-10 mx-auto max-w-2xl space-y-6 text-center">
                    ...
                    <p className="font-['Comfortaa']">Pompex ponuja celovite IT rešitve - od računalniškega servisa do razvoja spletnih strani in aplikacij. Vse na enem mestu.</p>
                </div>
                <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
                    <div className="relative mb-6 sm:mb-0">
                        <div className="bg-linear-to-b aspect-76/59 relative rounded-2xl from-zinc-300 to-transparent p-px dark:from-zinc-700">
                            <Image 
                                ...
                                alt="Cozy coding workspace - Pompex development environment" 
                                width={2700} 
                                height={1440} 
                                loading="lazy"
                    ...
                    <div className="relative space-y-4">
                        <p className="text-muted-foreground font-['Comfortaa']">
                            Pompex je dinamično podjetje, specializirano za celovite IT storitve, ki obsegajo sistemsko podporo, razvoj programskih rešitev ter izdelavo spletnih platform in aplikacij.
                        </p>
                        <p className="text-muted-foreground font-['Comfortaa']">
                        ...
                        <div className="pt-6">
                            <blockquote className="border-l-4 pl-4">
                                ...
                                <div className="mt-6 space-y-3">
                                    <cite className="font-['Comfortaa'] block font-medium">Pompex ekipa</cite>
